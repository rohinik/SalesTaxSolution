...
public class BasketOfProductTest extends Specification {
    ...
    def "should calculate the tax for given basket 1"() throws Exception {
        ...
        double grandTotal = basketOfProducts.getTheProductFromShop(value)

        then:
        grandTotal == 29.83
    }

    def "should calculate the tax for given basket 2"() throws Exception {
        when:
        basketOfProducts = new BasketOfProducts()
    ...
    def "should calculate the tax for given basket 3"() throws Exception {
        when:
